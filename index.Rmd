...
# a valid token
token <- "CAACEdEose0cBAFEVJ8DsWaMJvRaVflhJrI4FfKeb4nroqiN44ND0uhj5WpNFSMGTCcQUYw7AEUkt3pbiX5Ilcpdto90oMaPyEZBOHAnLDJCZCB5ZA3FrLuVzWGLdNQ6xdVpYMZBhyEhAeR9L4NK2uyc43Anp9eZBRW6zc0RAFay206UFY7FKTNOluSiZA4OZBeNhY27NmSk1QZDZD"
...
```{r run}
all_posts <- getPostId("2015-01-01", token=token) %>%
